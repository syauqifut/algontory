...
<head>
	<title>Dashboard | Admin Algontory</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="<?=base_url()?>assets/admin/img/logotext.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?=base_url()?>assets/admin/img/user.png" class="img-circle" alt="Avatar">
							<span>Admin</span>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?=base_url('index.php/admin')?>" class=""><i class="lnr lnr-home"></i> <span>Home</span></a></li>
						<li><a href="<?=base_url('index.php/kegiatan')?>" class=""><i class="lnr lnr-bookmark"></i> <span>Kegiatan</span></a></li>
						<li><a href="<?=base_url('index.php/prestasi') ?>" class=""><i class="lnr lnr-bookmark"></i> <span>Prestasi</span></a></li>
						<li><a href="<?=base_url('index.php/ekstra') ?>" class=""><i class="lnr lnr-bookmark"></i> <span>Ekstrakulikuler</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
